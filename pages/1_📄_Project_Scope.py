...
st.markdown(
    """
    This project is part of a data science training course context. The objective is to predict the energy performance diagnostic of housing from its features. \n
    ...
    **Steps of the project** :
    ...
    - Then we will study the data to understand how housings' characteristics impact the energy performance diagnostic.
    - Then we will use machine learning classification models to predict the energy performance diagnostic housing from a dataset.
"""
)
