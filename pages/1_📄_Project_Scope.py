...
st.markdown(
    """
    This project is part of a end of data science training project context. The objective is to predict the energy performance class of a housing from its characteristics. \n
    ...
    **Steps of the project** :
    ...
    - Then we will use machine learning classification models to predict the energy performance class of housing dataset.
"""
)
